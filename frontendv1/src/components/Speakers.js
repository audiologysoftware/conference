...
const speakersData = [
    ...
    { name: 'Dr. Vipul Arora,', designation: 'Associate Professor, IIT, Kanpur', image: '/img/speakers/Vipul.jpg', link: 'speaker-details.html' },
    ...
    { name: 'Dr Angie Canning', designation: 'Speech Pathologist(Senior Paediatric) Gold Coast University Hospital, South Port, Australia', image: '/img/speakers/AngieCanning.jpg', link: 'speaker-details.html' },
    ...
    { name: 'Ms. Kavya S', designation: 'Speech Language Pathologist, Magpie Speech Therapy, Bengaluru', image: '/img/speakers/Kavya.jpg', link: 'speaker-details.html' },
